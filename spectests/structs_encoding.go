...
// Hash: 846e0f4fdd30b52278922683e41ab4bd6018cd36e1a780133029f924aa605279
package spectests
...
func (b *BeaconState) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (9) 'Eth1DataVotes'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, num, 32)
		} else {
	...
	// Field (15) 'PreviousEpochParticipation'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(1099511627776, numItems, 1))
		} else {
